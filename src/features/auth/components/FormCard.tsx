...
export const FormCard: React.FC<FormCardProps> = ({ title, subtitle, children, footer, error }) => {
    return (
        <div className="min-h-screen flex items-center justify-center p-6 py-12 bg-surface">
            ...
            <div className="w-full max-w-lg z-10 animate-fade-in-up">
                ...
                <div className="bg-surface-light/40 backdrop-blur-xl rounded-3xl p-8 sm:p-10 border border-white/10 shadow-2xl">
                    {/* Error Alert */}
                    {error && (
                        <div className="mb-6 p-4 rounded-2xl bg-danger/10 border border-danger/20 text-danger text-sm font-medium flex items-center gap-3">
